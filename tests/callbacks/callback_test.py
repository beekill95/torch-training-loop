...
from training_loop.callbacks.callback import TEvent
...
def test_raise_stop_training(mocker):
    ...
    events: dict[TEvent, dict] = {
        "training_begin": {},
        "training_end": {},
        "epoch_begin": {"epoch": 1},
        "train_batch_begin": {"batch": 1},
        "train_batch_end": {"batch": 2, "logs": {"batch": 2}},
        "val_batch_begin": {"batch": 3},
        "val_batch_end": {"batch": 4, "logs": {"batch": 4}},
    }
